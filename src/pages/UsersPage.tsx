...
export default function UsersPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => { qc.invalidateQueries({ queryKey: ['usuarios'] }); setShowForm(false); toast.success('Usuário criado!') },
  ...
  const [form, setForm] = useState({ nome: '', email: '', senha: '', telefone: '', crmv: '' })
  ...
  const columns = [
    ...
    { key: 'clinicas', header: 'Clínicas', render: (u: Usuario) =>
