...
import { produtosApi } from '@/api/products.api'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          <div className="bg-card border border-border rounded-xl p-5">
            <h3 className="font-semibold mb-3">Informacoes Gerais</h3>
            <div className="space-y-2 text-sm">
              ...
              {produto.apresentacao && (
                <p><span className="text-muted-foreground">Apresentacao:</span> {produto.apresentacao}</p>
              )}
              {produto.codigoBarras && (
                <p><span className="text-muted-foreground">Codigo de Barras:</span> {produto.codigoBarras}</p>
              )}
              {produto.lote && (
              ...
              {produto.localizacao && (
                <p><span className="text-muted-foreground">Localizacao:</span> {produto.localizacao}</p>
              )}
              <div className="flex items-center gap-2">
          ...
          {/* Precos */}
          <div className="bg-card border border-border rounded-xl p-5">
            <h3 className="font-semibold mb-3">Precos</h3>
            <div className="space-y-2 text-sm">
              <p>
          ...
          <div className="bg-card border border-border rounded-xl p-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="p-4 bg-secondary rounded-lg text-center">
                ...
                <p className="text-xs text-muted-foreground mt-1">Minimo</p>
              </div>
              <div className="p-4 bg-secondary rounded-lg text-center">
                <p className="text-2xl font-bold">{produto.estoqueMaximo ?? '---'}</p>
                <p className="text-xs text-muted-foreground mt-1">Maximo</p>
              </div>
              <div className="p-4 bg-secondary rounded-lg text-center">
