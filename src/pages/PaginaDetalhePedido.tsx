...
import type { ItemPedido } from '@/api/pedidos.api'
        ...
        <div className="space-y-4">
          <div className="bg-card border border-border rounded-xl p-5">
            ...
            <div className="space-y-2 text-sm">
              ...
              {pedido.observacoes && (
                <p><span className="text-muted-foreground">Observações:</span> {pedido.observacoes}</p>
              )}
              ...
              {pedido.dataAprovacao && (
                <p><span className="text-muted-foreground">Data aprovação:</span> {formatDateTime(pedido.dataAprovacao)}</p>
              )}
            </div>
          </div>
